  ...
  if (error || !data) return (
    <div style={s.page}>
      <div style={s.wrap}>
        ...
        <div style={s.bodyText}>This link may be invalid or expired. Contact your Threefold representative for a new link.</div>
      </div>
    </div>
  )
  ...
  return (
    <div style={s.page}>
      <div style={s.wrap}>
        ...
        <div style={s.section}>
          ...
          <div style={s.statusRow}>
            ...
            {data.estimatedDelivery && (
              <span style={s.deliveryText}>Est. Delivery — {data.estimatedDelivery}</span>
            )}
          </div>
        </div>
            ...
            {PHASES.map((phase, i) => {
              ...
              return (
                <div key={phase} style={s.timelineRow}>
                  ...
                  <span style={{
                    ...s.timelineLabel,
                    color: done ? '#aaa' : current ? '#0a0a0a' : '#ccc',
                    fontWeight: current ? 700 : 400,
                    textDecoration: done ? 'line-through' : 'none',
                  }}>
                    {phase.toUpperCase()}
                  </span>
                  <span style={s.timelineTick}>
                    {done ? '✓' : current ? '←' : ''}
                  </span>
                </div>
              )
        ...
        {data.designVersions && data.designVersions.length > 0 && (
          <>
            <div style={s.rule} />
            <div style={s.section}>
        ...
        <div style={s.section}>
          ...
          <a href="mailto:hello@threefoldsupply.co" style={s.btnOutline}>
            CONTACT THREEFOLD →
          </a>
        </div>
...
const s: Record<string, React.CSSProperties> = {
  ...
  wrap: { maxWidth: '660px', margin: '0 auto', padding: '64px 32px 96px' },
