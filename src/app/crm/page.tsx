        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:gap-4 lg:items-start lg:pr-6">
          {leadsByStage.map(({ stage, leads: stageLeads }, stageIndex) => {
            ...
            <div
              ...
              className={
                isLostColumn
                  ? "w-full lg:w-[250px] lg:shrink-0 rounded-[2rem] border border-slate-300 bg-slate-100 p-3 shadow-sm md:p-4 lg:ml-4 lg:border-l-4 lg:border-l-slate-400"
                  : "w-full lg:w-[250px] lg:shrink-0 rounded-[2rem] border border-slate-200 bg-white p-3 shadow-sm md:p-4"
              }
            >
