  ...
  return (
    <div className="min-h-screen min-w-0 space-y-6 text-xs md:text-sm">
      ...
      <div className="bg-zinc-100 pb-6 lg:-mx-8 lg:overflow-x-auto lg:px-8 lg:pb-8">
        <div className="flex flex-col gap-2.5 lg:flex-row lg:gap-4 lg:items-start lg:pr-6">
          {leadsByStage.map(({ stage, leads: stageLeads }, stageIndex) => {
            return (
            <div key={stage} className="w-full rounded-2xl border border-slate-200 bg-white p-2 shadow-sm md:p-4 lg:w-[295px] lg:shrink-0 lg:rounded-[2rem]">
              <div className="flex items-center justify-between gap-3 border-b border-slate-200/60 pb-2.5 md:pb-4">
                <div>
