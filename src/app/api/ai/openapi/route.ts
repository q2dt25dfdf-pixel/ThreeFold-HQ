                    ...
                    properties: {
                      ...
                      summary: {
                        ...
                        properties: {
                          ...
                          netPosition:      { type: "number", description: "Gross profit minus paid operating expenses, minus Stripe fees (when available), minus custom-invoice sales tax held for CDTFA (all years, unremitted). Matches the Finances page Net Position." },
                          taxDue:           { type: "number" },
                          customTaxHeldAllYears: { type: "number", description: "Custom-invoice sales tax collected and not yet remitted, all years — a net-position deduction." },
                          stripeFees:       { type: "number", description: "Stripe processing + billing fees since go-live, from the balance-transaction history. 0 when stripeFeesAvailable is false." },
                          stripeFeesAvailable: { type: "boolean", description: "False when STRIPE_RESTRICTED_KEY is not configured in this environment; the fee deduction is then omitted." },
                        },
