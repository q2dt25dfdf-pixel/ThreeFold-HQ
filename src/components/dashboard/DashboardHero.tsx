...
export default function DashboardHero({ todayLabel }: DashboardHeroProps) {
  return (
    <section
      className="relative -mx-4 -mt-20 min-h-[500px] overflow-hidden rounded-none border border-slate-800/80 bg-[#020817] px-5 pb-8 pt-24 text-white shadow-[0_30px_90px_rgba(2,8,23,0.34)] sm:-mx-6 md:mx-0 md:mt-0 md:min-h-[500px] md:rounded-[2.25rem] md:px-12 md:py-14"
    ...
    >
      <Image
        ...
        className="pointer-events-none absolute inset-0 h-full w-full object-cover object-center md:object-[center_right]"
      />
      ...
      <div className="relative z-10 flex min-h-[368px] max-w-xl flex-col justify-center md:min-h-[372px]">
