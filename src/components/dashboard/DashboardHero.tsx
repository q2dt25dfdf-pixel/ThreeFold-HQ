...
export default function DashboardHero({ todayLabel }: DashboardHeroProps) {
  return (
    <section
      className="relative -mx-4 -mt-20 min-h-[520px] overflow-hidden rounded-none border border-slate-800/80 bg-slate-950 bg-cover bg-center px-5 pb-8 pt-24 text-white shadow-[0_30px_90px_rgba(2,8,23,0.34)] sm:-mx-6 md:mx-0 md:mt-0 md:min-h-[440px] md:rounded-[2.25rem] md:px-12 md:py-14"
      style={{ backgroundImage: "url('/bay-area-hero-bg.png')" }}
      aria-label="Threefold operations dashboard hero"
    >
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,rgba(2,8,23,0.94)_0%,rgba(2,8,23,0.82)_28%,rgba(2,8,23,0.45)_54%,rgba(2,8,23,0.16)_100%)]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_22%_38%,rgba(37,99,235,0.24),transparent_30%),linear-gradient(180deg,rgba(2,8,23,0.12)_0%,rgba(2,8,23,0.32)_100%)]" />
      ...
      <div className="relative z-10 flex min-h-[388px] max-w-xl flex-col justify-center md:min-h-[312px]">
